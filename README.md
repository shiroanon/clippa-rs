# Clippa-rs : A Clipboard Manager written in rust : 
## clippa-harvest 
a service which run in background listening for the links you copy and automatically add them in RAW .txt (atleast currently) 
## clippa-manage 
